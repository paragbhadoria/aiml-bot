...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File jayDir = new File(getApplicationContext().getExternalFilesDir(null).getAbsolutePath() + "/hari/bots/Hari");
        ...
        MagicStrings.root_path = getApplicationContext().getExternalFilesDir(null).getAbsolutePath() + "/hari";
